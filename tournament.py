...
def tournament(interface1, interface2, game_number=100, movetime=10, size=8, opening_moves=[]):
    ...
    print('Finished in %i seconds' % (time.time.perf_counter() - begin))
    return p1_score, p2_score, rollouts_info, time.time.perf_counter() - begin
